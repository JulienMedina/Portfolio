...
import DiagonalLinesSVGComponent from "../base/DiagonalLinesSVGComponent"; // Import du composant SVG
...
const Hero = ({ isNavOpen }) => {
  ...
  return (
    ...
    >
      {/* Appel du composant DiagonalLinesSVGComponent plusieurs fois avec différentes positions et durées */}
